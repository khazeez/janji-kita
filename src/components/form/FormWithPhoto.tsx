...
export default function Form2() {
  ...
  const totalSteps = 6; // Ubah dari let ke const
        ...
        <footer className='fixed bottom-0 left-0 right-0 bg-gray-800 border-t border-gray-700 z-50'>
          <div className='max-w-4xl mx-auto px-4 py-4'>
            <button
              ...
              // PERBAIKAN: Ubah dari currentStep === 6 menjadi currentStep === totalSteps
            ...
            >
              {currentStep === totalSteps ? 'Submit' : 'Lanjut'}
              {/* PERBAIKAN: Ubah text button */}
            </button>
          </div>
        </footer>
      )}
