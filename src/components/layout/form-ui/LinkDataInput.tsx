      ...
      <div className='space-y-6'>
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className='text-xs text-gray-500'>Buat link unik untuk undangan digital Anda</p>
          </div>
        </div>
        ...
        <div className='bg-gray-800 border border-gray-700 rounded-2xl p-8 space-y-8'>
          <div className="space-y-3">
            ...
            <div className='flex items-stretch group'>
              <div className='px-4 flex items-center bg-gray-700 border border-r-0 border-gray-600 rounded-l-xl text-gray-500 whitespace-nowrap text-sm font-medium transition-colors group-focus-within:border-pink-500/50 group-focus-within:bg-white/[0.08]'>
                janjikita.art/
              </div>
              <input
                type='text'
                ...
                className={`flex-1 px-4 py-3.5 bg-gray-800 border border-gray-600 rounded-r-xl text-white focus:outline-none transition-all font-medium ${
                  validationMessage?.type === 'error'
                    ...
                    : 'focus:border-pink-500/50 focus:bg-gray-700 focus:ring-pink-500/10'
                }`}
            ...
            <div className='mt-2 flex items-center gap-2 px-1'>
              {isChecking ? (
                ...
                <div className={`text-[10px] font-bold uppercase tracking-wider flex items-center gap-1.5 ${
                  ...
                  validationMessage.type === 'success' ? 'text-green-400' : 'text-gray-500'
                }`}>
