...
export default function ResultScreenSuccsess({ data }: Props) {
  return (
    <div className='fixed inset-0 bg-gray-900/80 flex items-center justify-center z-[100] p-4 animation-in fade-in duration-500'>
      <div className='bg-gray-900 border border-gray-700 rounded-[2.5rem] max-w-md w-full p-10 shadow-3xl relative overflow-hidden group animate-in zoom-in-95 duration-500'>
        ...
        <div className='space-y-4 relative'>
          ...
          <Link
            ...
            className='w-full flex items-center justify-center gap-3 px-8 py-5 bg-gray-800 hover:bg-gray-700 text-white font-bold rounded-2xl transition-all duration-300 border border-gray-700 group/btn'
          >
          ...
          <Link
            href="/dashboard"
            className="w-full flex items-center justify-center gap-2 text-xs font-bold text-gray-600 hover:text-white transition-colors uppercase tracking-widest pt-2"
          >
