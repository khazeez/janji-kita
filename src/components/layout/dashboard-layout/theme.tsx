...
const catalogues: CatalogueItem[] = [
  ...
  },
  {
    ...
    description:
      'Video pernikahan cinematic dengan kualitas premium dan editing profesional.',
    features: [
      '4K Resolution',
      'Color grading',
      'Slow motion',
  ...
  },
  {
    ...
    description:
      'Filter Instagram dan TikTok dengan efek romantis untuk momen spesial Anda.',
    features: [
      'Custom effect',
      'Brand name',
      'Wedding date',
  ...
  },
  {
    ...
    description:
      'Paket video pernikahan luxury dengan tim profesional dan equipment high-end.',
    features: [
      'Full day coverage',
      'Multiple cameras',
      'Professional editor',
  ...
  },
  {
    ...
    description:
      'Set filter vintage untuk Instagram dan TikTok dengan efek klasik yang timeless.',
    features: [
      '3 filter variants',
      'Vintage effects',
      'Customizable',
              ...
              <div className='space-y-2 sm:space-y-4'>
                <div className='relative rounded-lg overflow-hidden shadow-lg'>
                  ...
                  <div className='absolute top-2 left-2 flex gap-1.5'>
                    ...
                    <span
                      className={`text-[10px] font-semibold px-2 py-0.5 rounded-full shadow-lg border ${getProductTypeColor(
